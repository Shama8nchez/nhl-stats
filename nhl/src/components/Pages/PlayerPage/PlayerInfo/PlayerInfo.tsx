  ...
  return (
    <div className={classes.playerInfo}>
      <h1 className={classes.teamTitle}>
        {player[0].nationality ? <img src={flags[player[0].nationality]} alt='flag' height={16}/> : <></>} {player[0].fullName}
      </h1>
      ...
      <div><strong>From: </strong>{player[0].birthCountry}, {player[0].birthCity} 
        {player[0].birthStateProvince ? <>({player[0].birthStateProvince})</> : ''}</div>
